...
// Ed: stop url's suddenly changing:
...
// Ed: when I get here from 'linkto', controller content is not set which results in an error
// in the console.  Will come back to this later.
// could do controller.set('content', {}) if its not set....
  ...
  postCountChanged: function() {
    ...
    // above sometimes causes this error:
    //Error: assertion failed: Cannot delegate set('seenBottom', false) to the 'content' property of object proxy <Discourse.TopicController:ember726>: its 'content' is undefined.
...
Discourse.HappeningTopicView.reopenClass({
